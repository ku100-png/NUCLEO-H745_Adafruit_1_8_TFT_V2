...
//  return res;
  /* USER CODE BEGIN READ */
		SD_disk_read (lun, buff, sector, count);
		return RES_OK;
  /* USER CODE END READ */	
}
...
//  return res;
  ...
  /* USER CODE HERE */
		SD_disk_write (lun, buff, sector, count);
    return RES_OK;
  /* USER CODE END WRITE */
}
#endif /* _USE_WRITE == 1 */
...
//  return res;
  ...
  /* USER CODE BEGIN IOCTL */
    DRESULT res = SD_disk_ioctl (lun, cmd, buff);
    return res;
  /* USER CODE END IOCTL */
}
#endif /* _USE_IOCTL == 1 */
