...
The Cortex-M7 manages bmp images display on the Adafruit 1.8" TFT shield Ver2 when plugged (from SD-card)
Each time a new image is displayed the Cortex-M7 sends notification to Cortex-M4 that blinks LED2.
The Adafruit 1.8" TFT shield V2 is always detected.
   ...
   -------------------
     ...
     - Choose the desired display mode: Press Joystick DOWN for automatic mode
       ...
       - Manual Mode selected:
		 ...
		 Pressing Button A on Adafruit 1.8" TFT shield V2 terns on LED1 on NUCLEO board.
		 Pressing Button B on Adafruit 1.8" TFT shield V2 terns off LED1 on NUCLEO board.
		 Pressing Button C on Adafruit 1.8" TFT shield V2 toggles LED3 on NUCLEO board.
...
access to uSD card to parse bmp images:
 ...
 - If SD Card is not FAT formatted, a message will be displayed on TFT.
   ...
   files available in folder "Media/" with 128x160 resolution and 16 bit color depth.
 ...
 - If the SD card is empty or it contains files other than bitmap image, a message will
   ...
   which are respecting the following criteria:
    ...
    o Height: 160 pixels
    o Bit depth: 16
    o Item type: BMP file, Max count of .bmp files is 25
...
Demonstrations,  multiprocessor, Adafruit, Shield V2, TFT, Joystick, SD Card, Display,
...
@par Hardware and Software environment
  ...
  - A SDSC microSD card (capacity up to 4GB), must contain the .bmp
   files available in folder "Media/" with 128x160 resolution and 16 bit color depth.
...
For more details about the adafruit 1.8" TFT shield V2, please visit:
